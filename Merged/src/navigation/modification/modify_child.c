...
int		nfAddChildInSegment(int new_id, const char *name)
{
  segment	*new;
  int		real_id;
...
int		nfAddChildInSegmentID(int id, int new_id, const char *new_name)
{
  int		error_code;
  int		last_pos_id;
...
int		nfAddChildInSegmentName(const char *name, int new_id, const char *new_name)
{
  int		error_code;
  char		*last_pos_name;
...
int		nfAddChildInChildID(int id, int new_id, const char *new_name)
{
  int		error_code;
  int		last_pos_id;
...
int		nfAddChildInChildName(const char *name, int new_id, const char *new_name)
{
  int		error_code;
  char		*last_pos_name;
